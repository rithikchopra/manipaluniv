                ...
                <div className="section-block">
                  <div className="section-inner section-fit section-relative">
                    ...
                    <div className="widget item-absolute headline  " id="element-651" data-at="headline">
                      <div className="contents">
                        <h1>
                          <span className="x_00098c5b x_19c19dde"><span className="x_f2074b6c">Start your dream job with an 6 lakh salary package.&nbsp;</span><span className="x_f2074b6c">Join the first-ever job assured fintech program for a successful future.</span></span>
                        </h1>
                      </div>
                    </div>
                ...
                <div className="section-block">
                  <div className="section-inner section-fit section-relative">
                    <div className="widget item-absolute headline  " id="element-721" data-at="headline">
                      <div className="contents">
                        <h1>
                          <span className="x_82ea7ee4 x_52f6981f"><span className="x_b0c52866"><strong>Your Dream Role in Tech Starting Salary ₹6 Lakhs p.a. </strong></span></span>
                        </h1>
                      </div>
                    </div>
                    ...
                    <div className="widget item-absolute headline  " id="element-746" data-at="headline">
                      <div className="contents">
                        <h1>
                          <span className="x_8b236db7 x_0fa34b5f"><span className="x_f9a61538"><strong>₹ 99,000</strong></span></span>
                        </h1>
                      </div>
                    </div>
...
export default AxisBankSubPage2